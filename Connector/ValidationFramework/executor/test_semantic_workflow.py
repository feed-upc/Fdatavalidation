...
def main():
    ...
    pc_file = "../planner/policy_checker_UPENN-GBM_clinical_info_v21_timestampcsv_semantic.ttl"
    ...
    output_file = "../planner/policy_checker_UPENN-GBM_clinical_info_v21_timestampcsv_with_reports.ttl"
    ...
    sdm_file = "../../../FederatedComputationalGovernance/SemanticDataModel/sdm_with_pcs.ttl"
    output_sdm = "../../../FederatedComputationalGovernance/SemanticDataModel/sdm_with_pcs_with_validation_reports.ttl"
